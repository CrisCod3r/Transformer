...
class LeNet5(nn.Module):
    def __init__(self):
        ...
        self.full1 = nn.Linear(in_features = 16 * 9 * 9, out_features = 120)
        self.full2 = nn.Linear(in_features = 120, out_features = 84)
        self.full3 = nn.Linear(in_features = 84, out_features = 2)
